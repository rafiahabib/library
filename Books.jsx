...
function Books({addbooks}) {
  ...
  return (
    <div className='w-1/2 flex items-center justify-center flex-col mx-8 mt-10 p-6 border-2 rounded-md border-white backdrop-blur-md'>
      ...
      <input type='text' value={year} placeholder='Year' className='w-full bg-black text-white p-2 mb-2 my-2 rounded' onChange={(event)=>setYear(event.target.value)} ></input>
